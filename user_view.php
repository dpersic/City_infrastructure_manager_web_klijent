     ...
     <div class="container-fluid">
      <div class="topnav" id="myTopnav">
        <a type="button" href="index.php" id="float_right_logout"><span class="glyphicon glyphicon-new-window"></span>Povratak na početnu stranicu</a>
                  <a href="user_view.php" class="active">Pregled svih današnjih ispada</a>  
                  <a href="user_view_svi_ispadi.php">Pregled svih ispada</a>              
       </div>
       </div>
       </nav>
      </div>
    ...
    <div class="col-md-12">
      <div class="row">
       <div class="col-sm-12" style="margin-top:30px;">
          ...
          <button  id="dropdown_filter_zupanija_user_view" class="btn btn-default dropdown-toggle" style="width: auto; text-align: center; margin-left: 250px"></button>
          <button id="dropdown_filter_vrsta_ispada_user_view"  class="btn btn-default dropdown-toggle" style="width: auto; text-align: center;"></button>
 
      </div>   
    </div>
            <table class="table" id="Tablica_ispada_user_view">
                <thead>
                  <tr>
                      <th>Broj ispada</th>
                      <th>Naziv grada</th>
...
<script type="text/javascript" async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAleo4r61WEjsRmizS5SWLMa2k_rnYBDW4&callback=initMap_trenutanIspad"></script>
